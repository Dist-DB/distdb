...
| Non-functional behavior | Red | 2026-07-17 | server/serverlib | benchmark baselines, threshold checks, and trend ledger plumbing now exist; still need history accumulation, review cadence, and regression governance policy |
