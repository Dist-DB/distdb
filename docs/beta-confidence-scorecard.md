...
| Operability/upgrade safety | Yellow | 2026-07-17 | server/serverlib | rolling restart and adjacent-version cross-version/rollback drill evidence now published (`scripts/e2e/rolling_restart_upgrade_safety.sh`, `.github/workflows/operability-upgrade-safety.yml`, `.github/workflows/nightly-evidence.yml`, `docs/operability-upgrade-safety.md`, `docs/operability-runbooks.md`); still need wider declared compatibility-window matrix coverage and frozen WAL/catalog compatibility window assertions |
