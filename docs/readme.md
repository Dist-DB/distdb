...
- [installation-advisories.md](installation-advisories.md)
...
- [installation-advisories.md](installation-advisories.md): deployment-time constraints and operational advisories for stable startup/connectivity.
