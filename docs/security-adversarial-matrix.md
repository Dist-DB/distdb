...
1. Expand fault-injection matrix breadth beyond current malformed frame + trust-bootstrap + replay decode abuse paths (e.g., additional privilege-surface abuse scenarios across multi-database and role-like grant chains).
