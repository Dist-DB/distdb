...
THRESHOLD_PROFILE="${PERF_THRESHOLD_PROFILE:-default}"
...
case "$THRESHOLD_PROFILE" in
  ...
  default)
    ...
    DEFAULT_MAX_WRITE_P99_MS=180
    DEFAULT_MAX_READ_P95_MS=90
    DEFAULT_MAX_READ_P99_MS=140
    DEFAULT_MAX_MIXED_P95_MS=130
    DEFAULT_MAX_MIXED_P99_MS=200
    DEFAULT_MAX_RECOVERY_READY_MS=800

    DEFAULT_MIN_WRITE_THROUGHPUT=15
    DEFAULT_MIN_READ_THROUGHPUT=20
    DEFAULT_MIN_MIXED_THROUGHPUT=15
    ;;
  *)
    echo "[nonfunctional-thresholds][fail] unknown PERF_THRESHOLD_PROFILE=$THRESHOLD_PROFILE"
    exit 1
    ;;
esac

MAX_WRITE_P95_MS="${PERF_MAX_WRITE_P95_MS:-$DEFAULT_MAX_WRITE_P95_MS}"
MAX_WRITE_P99_MS="${PERF_MAX_WRITE_P99_MS:-$DEFAULT_MAX_WRITE_P99_MS}"
MAX_READ_P95_MS="${PERF_MAX_READ_P95_MS:-$DEFAULT_MAX_READ_P95_MS}"
MAX_READ_P99_MS="${PERF_MAX_READ_P99_MS:-$DEFAULT_MAX_READ_P99_MS}"
MAX_MIXED_P95_MS="${PERF_MAX_MIXED_P95_MS:-$DEFAULT_MAX_MIXED_P95_MS}"
MAX_MIXED_P99_MS="${PERF_MAX_MIXED_P99_MS:-$DEFAULT_MAX_MIXED_P99_MS}"
MAX_RECOVERY_READY_MS="${PERF_MAX_RECOVERY_READY_MS:-$DEFAULT_MAX_RECOVERY_READY_MS}"

MIN_WRITE_THROUGHPUT="${PERF_MIN_WRITE_THROUGHPUT:-$DEFAULT_MIN_WRITE_THROUGHPUT}"
MIN_READ_THROUGHPUT="${PERF_MIN_READ_THROUGHPUT:-$DEFAULT_MIN_READ_THROUGHPUT}"
MIN_MIXED_THROUGHPUT="${PERF_MIN_MIXED_THROUGHPUT:-$DEFAULT_MIN_MIXED_THROUGHPUT}"
