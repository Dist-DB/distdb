...
ensure_absent_path "server/src/core/comms/tls_support.rs"
...
ensure_pattern_present "pub use security::{" "server/src/core/comms/mod.rs" "comms exports tls support APIs from security"
ensure_pattern_present "build_tls_acceptor" "server/src/core/comms/mod.rs" "comms exports build_tls_acceptor"
ensure_pattern_present "build_tls_client_config" "server/src/core/comms/mod.rs" "comms exports build_tls_client_config"
ensure_pattern_present "negotiate_connector_stream" "server/src/core/comms/mod.rs" "comms exports negotiate_connector_stream"
...
ensure_no_pattern_in_server_src "core::comms::tls_support::" "legacy comms tls_support module imports"
