...
const CONNECTOR_STREAM_TIMEOUT_SECS_ENV: &str = common::settings::CONNECTOR_STREAM_TIMEOUT_SECS;
const CONNECTOR_CONNECT_TIMEOUT_SECS_ENV: &str = common::settings::CONNECTOR_CONNECT_TIMEOUT_SECS;
const CONNECTOR_HANDSHAKE_TIMEOUT_SECS_ENV: &str = common::settings::CONNECTOR_HANDSHAKE_TIMEOUT_SECS;
const CONNECTOR_CONNECT_RETRY_ATTEMPTS_ENV: &str = common::settings::CONNECTOR_CONNECT_RETRY_ATTEMPTS;
const PLATFORM_TLS_FINGERPRINT_ENV: &str = common::settings::PLATFORM_TLS_FINGERPRINT;
const CONNECTOR_TLS_FINGERPRINT_ENV: &str = common::settings::CONNECTOR_TLS_FINGERPRINT;
