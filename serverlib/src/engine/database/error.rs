...
impl std::fmt::Display for DatabaseError {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        match self {
            ...
            Self::ResourceUnavailable               => write!(f, "resource is unavailable; it is still loading and cannot serve queries yet"),
            ...
            Self::IndexPayloadDeserialize           => write!(f, "failed to deserialize index lifecycle payload"),
            ...
            Self::DuplicateOlapView                 => write!(f, "olap view already registered in database catalog"),
            Self::OlapViewNotFound                  => write!(f, "olap view not found in database catalog"),
